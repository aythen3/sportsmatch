...
entrenant al camp del meu poble. Toooop!...  más`}</Text>
            ...
            <View style={[styles.contenidoPost, styles.postPosition]}>
              ...
              <View
                style={[
                  styles.botonPromocionarFrame,
                  styles.footerPostSpaceBlock,
                ]}
              >
                <LinearGradient
              ...
              <View style={[styles.footerPost, styles.footerPostSpaceBlock]}>
...
export default SiguiendoUsuarios1;
