                  ...
                  >
                    ...
                    >
                      <Text
                        ...
                        disabled={offer?.inscriptions?.includes(sportman?.id)}
                        onPress={() => {
                          if (!offer?.inscriptions?.includes(sportman?.id)) {
                        ...
                        style={{
                          color: offer?.inscriptions?.includes(sportman?.id)
                            ? '#fff'
