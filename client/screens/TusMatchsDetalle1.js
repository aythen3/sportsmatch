  ...
  return (
    <View style={styles.tusMatchsDetalle}>
      ...
      <View style={styles.vectorParent}>
        ...
        />
        <Text style={[styles.uniEsportivaMatar, styles.match1Typo]}>{`Jordi
Espelt`}</Text>
        <Text style={[styles.masculino, styles.cmTypo]}>Masculino</Text>
        <Text style={[styles.text, styles.cmTypo]}>24</Text>
        <Text style={[styles.snior, styles.cmTypo]}>Sénior</Text>
        <Text style={[styles.pvot, styles.cmTypo]}>Pívot</Text>
        <Text style={[styles.cm, styles.cmTypo]}>190cm</Text>
        <Text style={[styles.matar, styles.cmTypo]}>Mataró</Text>
        ...
        <View style={styles.aceptarParent}>
          ...
          <View style={[styles.aceptar1, styles.aceptarSpaceBlock]}>
      ...
      <Image
        style={[styles.maskGroupIcon1, styles.iconFrameLayout]}
        contentFit="cover"
      ...
      <View style={styles.menuClub}>
        ...
        <Pressable
          style={[styles.ellipseGroup, styles.groupPosition]}
      ...
      <Image
        style={[styles.tusMatchsDetalleChild, styles.iconFrameLayout]}
        contentFit="cover"
        source={require("../assets/ellipse-83.png")}
      />
      <Image
        style={[styles.tusMatchsDetalleItem, styles.tusLayout]}
        contentFit="cover"
        source={require("../assets/line-9.png")}
      />
      <Image
        style={[styles.tusMatchsDetalleInner, styles.tusLayout]}
        contentFit="cover"
        source={require("../assets/line-9.png")}
      />
    </View>
