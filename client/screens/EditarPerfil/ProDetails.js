        ...
        >
          <View style={{ gap: 10, flex: 1 }}>
            ...
            <View style={styles.topWrapper}>
              ...
              <Text style={styles.clubDetailsTitle}>Detalles del profesional</Text>
            </View>
            {/* =========================================================== */}
            {/* ======================= PROFILE PIC ======================= */}
            {/* =========================================================== */}
      ...
      borderRadius: 5,
            ...
            <View style={{ gap: 20, flex: 1 }}>
              <View style={{ gap: 5 }}>
                ...
                <CustomPicker
                  zIndex={10000}
                  array={['Jugador','Entrenador', 'Masajista', 'Ayudante de campo']}
                  placeholder={'Selecciona tu posicion'}
