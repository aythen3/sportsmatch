...
de Mataró desde el 2021`}</Text>
      ...
      <View style={[styles.groupParent, styles.groupLayout1]}>
        <View style={[styles.rectangleWrapper, styles.groupLayout1]}>
          <View style={[styles.groupChild3, styles.groupLayout1]} />
        </View>
      ...
      <View style={[styles.groupContainer, styles.groupLayout1]}>
        ...
        <View
          style={[styles.enviarMensajeWrapper, styles.menuClubChildPosition]}
        >
          <Text style={[styles.enviarMensaje, styles.timeTypo]}>
            Enviar mensaje
          </Text>
        </View>
      </View>
